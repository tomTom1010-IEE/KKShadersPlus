Shader "xukmi/HairFrontPlusDOF"
{
	Properties
	{
		...
		_src ("Src", Float) = 5.0
		_dst ("Dst", Float) = 10.0
		[Enum(Off,0,On,1)] _DOFPrepassZWrite ("DOF Depth Prepass ZWrite", Float) = 1.0
	...
	{
		LOD 600
		Tags {"Queue" = "AlphaTest+25" "RenderType" = "TransparentCutout" }
		// Outline
		Pass
		{
			Name "DepthPrepass"
